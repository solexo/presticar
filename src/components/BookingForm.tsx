...
Date: ${formData.pickup_date || 'À préciser'}`;
  ...
  const handleEmailBooking = () => {
    const subject = i18n.language === 'fr' ? 'Nouvelle réservation TAXI PARIS' : 'New TAXI PARIS Booking';
...
${formData.notes ? `Notes: ${formData.notes}` : ''}`;
    ...
    const mailtoLink = `mailto:Paristaxipro@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white py-4 rounded-xl text-lg font-semibold hover:from-amber-600 hover:to-orange-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
