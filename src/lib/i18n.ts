...
const resources = {
  en: {
    translation: {
      ...
      // Hero
      "hero.title": "Taxi Paris VTC - Private Driver Reservation 24/7",
      "hero.subtitle": "Premium Taxi VTC Service in Île-de-France",
      "hero.description": "TAXI PARIS offers professional drivers and high-end vehicles for all your travels in Île-de-France. Book taxi Paris, VTC Paris, airport transport, train station taxi in a few clicks.",
      ...
      "prices.note": "All prices exclude VAT. Rates are indicative and may vary depending on conditions.",
  ...
  fr: {
    translation: {
      ...
      "prices.note": "Prix H.T. Tarifs indicatifs, peuvent varier selon les conditions.",
